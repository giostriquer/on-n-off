...
function pr(seed: Seed, kind: "mine" | "review" | "assigned"): GithubPr {
  ...
  return {
    ...
    mergeKind: seed.queued !== undefined ? "queued" : (seed.merge ?? null),
...
const MINE: Seed[] = [
  ...
  { n: 398, title: "Tighten the CSP for the updater window", ci: "success", decision: "APPROVED", merge: "ready", minutesAgo: 41 },
  { n: 401, title: "Migrate the settings store to versioned JSON", ci: "pending", draft: true, minutesAgo: 12 },
  { n: 388, title: "Rename the tray menu entries", ci: "success", merge: "conflicts", minutesAgo: 900 },
];
...
const REVIEW: Seed[] = [
  ...
  { n: 527, title: "Prove semantic list scale behaviour at 10k rows", author: "devon", ci: "success", team: true, decision: "APPROVED", queued: 2, minutesAgo: 66 },
  { n: 91, title: "api: reject unsigned webhooks", repo: "acme/api", author: "lin", ci: "error", decision: "CHANGES_REQUESTED", minutesAgo: 190 },
  { n: 88, title: "api: paginate the audit log", repo: "acme/api", author: "lin", ci: "success", merge: "autoMerge", minutesAgo: 1440 },
  ...
  { n: 525, title: "Content-addressed state activation", author: "devon", ci: "success", decision: "APPROVED", merge: "blocked", minutesAgo: 15 },
  { n: 521, title: "Qualify client state ownership", author: "mara", ci: "pending", minutesAgo: 9 },
  { n: 519, title: "Production QC execution lane", author: "devon", ci: "success", merge: "behind", minutesAgo: 75 },
    ...
    pr(
      {
        ...
        merge: index % 7 === 0 ? "conflicts" : index % 3 === 0 ? "ready" : undefined,
