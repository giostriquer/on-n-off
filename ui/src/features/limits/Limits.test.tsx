...
describe("Limits", () => {
  ...
  it("offers a banked reset beside the current Codex account's actions and lists the count as a row", async () => {
    ...
    answer([okClaude()], [okCodex({ resetCredits: { availableCount: 2, nextExpiresAt: null } }), remembered]);
    renderLimits();
