...
vi.mock("$lib/api", () => ({
  readNotchState: () => Promise.resolve({ revision: 0, supported: false, settings: { enabled: false, displayId: null, edge: "right", size: "standard", show: "always", providers: ["claude", "codex", "antigravity", "cursor"], pullRequests: { enabled: true, lists: ["mine"] } }, displays: [], error: null }),
