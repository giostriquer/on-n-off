...
fn claude_lists_live_interactive_sessions_newest_first() {
    ...
    claude_file(
        ...
        200,
        serde_json::json!({
            "pid": 200, "sessionId": "bbbb-22", "name": "webapp-b4", "entrypoint": "cli",
            "cwd": "/Users/me/Documents/acme/webapp", "status": "busy",
    ...
    claude_file(
        ...
        serde_json::json!({
            ...
            "cwd": "/Users/me/Documents/acme", "status": "idle", "updatedAt": now_ms - 60_000
        }),
    );
...
fn codex_reads_recent_rollouts_and_infers_work_from_task_boundaries() {
    ...
    rollout(
        ...
        &[
            meta(
                "01a0-aaaa-42",
                "/Users/me/Documents/acme/webapp",
                "Codex Desktop",
            ),
            event("task_started"),
            event("task_complete"),
    ...
    rollout(
        ...
        "rollout-b.jsonl",
        &[
            meta("01a0-bbbb-77", "/Users/me/Documents/acme", "codex_cli_rs"),
            event("task_started"),
            event("turn_aborted"),
        ],
    );
    ...
    let idle = sessions.iter().find(|s| s.name == "acme-77").unwrap();
